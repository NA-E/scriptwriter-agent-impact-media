...
export default function ProjectPage() {
  ...
  const fetchProject = async () => {
    if (!projectId || !user?.id) {
      console.log("Missing projectId or user.id:", {
        projectId,
        userId: user?.id,
      });
      return;
  ...
  const getStepStatus = (stepId: number) => {
    ...
    if (stepId === 1) {
      ...
      const previousStepData = projectSteps.find(
        (s) => s.step_number === stepId - 1,
      );
      ...
      <div className="flex items-center justify-between text-green-400">
        ...
        {typeof stepData.processing_cost === "number" ? (
          ...
          <div className="text-sm text-gray-400">
            Cost:{" "}
            {stepData.processing_cost === null
              ? "N/A"
              : String(stepData.processing_cost)}
          </div>
        )}
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen dark-world-bg">
      {/* Header */}
              ...
              {(() => {
                ...
                if (stepData && stepData.status === "completed") {
                  ...
                  return renderProcessingState(
                    "Processing transcript analysis...",
                  );
                } else {
                  return (
                    <div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => {
                              ...
                              setProject((prev) =>
                                prev ? { ...prev, context: newContext } : null,
                              );
                            }}
                            onBlur={(e) => {
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setProject((prev) =>
                                prev ? { ...prev, youtube_url: newUrl } : null,
                              );
                            }}
                            onBlur={(e) => {
                              saveProjectChanges({
