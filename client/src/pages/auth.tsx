        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-16 flex justify-center">
            <Button 
              ...
              disabled={loading}
              className="bg-white hover:bg-gray-100 text-black font-medium py-3 px-6 rounded-lg transition-colors duration-200 inline-flex items-center justify-center space-x-2 border border-gray-200 hover:border-gray-300"
            >
